...
if st.button("Run Optimization"):
    ...
    if total_sector < 1:
        ...
        frontier_df = generate_frontier(mu, Sigma)
        ...
        # Optimal point
        optimal_chart = alt.Chart(optimal_df).mark_point(
            size=200,
            shape="diamond",
            color="red"
        ).encode(
        ...
        # Layer charts
        layered_chart = alt.layer(frontier_chart, optimal_chart)
